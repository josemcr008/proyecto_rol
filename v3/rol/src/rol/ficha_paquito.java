 ...
 * @author jomac
 */
public class ficha_paquito extends javax.swing.JFrame {

    /**
     * Creates new form Ficha_jose
     */
    public ficha_paquito() {
        initComponents();
        this.setTitle("Ficha paquito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ficha_paquito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ficha_paquito().setVisible(true);
            }
        });
    }
