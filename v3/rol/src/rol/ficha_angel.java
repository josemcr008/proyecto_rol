 ...
 * @author jomac
 */
public class ficha_angel extends javax.swing.JFrame {

    /**
     * Creates new form ficha_angel
     */
    public ficha_angel() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ficha_angel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ficha_angel().setVisible(true);
            }
        });
    }
