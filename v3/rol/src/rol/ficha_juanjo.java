 ...
 * @author jomac
 */
public class ficha_juanjo extends javax.swing.JFrame {

    /**
     * Creates new form ficha_juanjo
     */
    public ficha_juanjo() {
        initComponents();
        File archivo = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ficha_juanjo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ficha_juanjo().setVisible(true);
            }
        });
    }
