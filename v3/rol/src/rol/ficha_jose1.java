 ...
 * @author jomac
 */
public class ficha_jose1 extends javax.swing.JFrame {

    /**
     * Creates new form ficha_jose1
     */
    public ficha_jose1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ficha_jose1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ficha_jose1().setVisible(true);
            }
        });
    }
